...
wait1()
findXpath(xpath='/html/body/div[2]/div[2]/div/div[2]/div/div/div/div/div[2]/div/table/tbody/tr[1]/td[2]/label[2]/input').click() #单击选中审核不通过按钮
findClassName(name='txtarea').send_keys('pyselenium港口交货审核不通过') #输入备注信息
wait1()
